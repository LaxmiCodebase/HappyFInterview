...
public class Testcase101 {
	...
	public static void main(String[] args) throws InterruptedException, AWTException {
		...
		// Getting the absolute xpath can be avaoided because html page div(structure) may change in future. Instead we can find another locator
		...
		// Instead of Thread.sleep, we can use WebDriverWait.
	      Thread.sleep(3000);
...
//instead of absolute path we can use another locator 
...
public class PagesforAutomationAssignment {
	...
	//Closing parathesis for HomePage needs to be added  "}"
	...
	//Closing parathesis for PagesforAutomationAssignment needs to be added .
}